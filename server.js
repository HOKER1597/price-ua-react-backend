...
const pool = new Pool({
  connectionString: process.env.DATABASE_URL || 'postgresql://postgres.vycccrkohgfaqpqeymrn:[YOUR-PASSWORD]@aws-0-eu-north-1.pooler.supabase.com:5432/cosmetic-ua',
